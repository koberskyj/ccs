...
S neustálým rozvojem informačních technologií pronikají počítačové systémy do všech aspektů lidského života, kde se stále častěji setkáváme s takzvanými reaktivními systémy.
...
V kapitole \ref{sec:reaktivni_systemy} se probírá teoretický základu reaktivních systémů a detailně popisuje formalismus kalkulu komunikujících systémů, ohodnocených přechodových systémů a strukturální operační sémantiky. 
...
Výsledná verze aplikace je díky nástroje Github Pages \cite{github_pages_2026_github} nazasena na veřejné adrese \texttt{https://ccs.koberskyj.cz/}. 
Během psaní této práce byla zejména při formátování textu využívána umělá inteligence \cite{googlellc_2024_gemini}.
