...
Jako primární vývojové prostředí byl zvolen editor Visual Studio Code (VS Code) od společnosti Microsoft \cite{microsoft_2025_visual}. 
...
Node.js je běhové prostředí (runtime environment) postavené na enginu V8 z prohlížeče Google Chrome, které umožňuje spouštět JavaScript kód mimo webový prohlížeč \cite{nodejs_2025_nodejs}. 
...
Pomocí \texttt{npm} byly do projektu integrovány veškeré knihovny zmíněné v této kapitole. 
...
Pro vývoj uživatelského rozhraní byla použita JavaScript knihovna React.js, vyvinutá společností Meta \cite{metaopensource_2025_react}. 
...
\begin{itemize}
    \item \textbf{cytoscape-dagre:} Rozšíření, které integruje algoritmus Dagre pro hierarchické a deterministické rozvržení grafu. Tento algoritmus je využit při vizualizaci postupně rozvíjených stavových prostorů LTS. Detailněji je tento algoritmus popsán v kapitole \ref{sec:theory_dagre}.
